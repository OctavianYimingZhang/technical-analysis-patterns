...
No further updates will be made here. Full commit history is preserved in the monorepo at `skills/technical-analysis-patterns/` via `git subtree`.

## Where it lives now

- **Monorepo**: https://github.com/OctavianYimingZhang/equity-research-suite
- **This skill's new path**: [`skills/technical-analysis-patterns/`](https://github.com/OctavianYimingZhang/equity-research-suite/tree/main/skills/technical-analysis-patterns)
...
If you had the older local name `technical-analysis`, the installer moves it aside to `.bak` automatically.
